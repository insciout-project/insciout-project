...
A full inventory of the columns can be found in html format [here](file:///Users/racheladams/insciout-project2/documentation/Inventory_of_the_Columns.html)  

Or in .csv format on the main page of the repository [here](https://github.com/insciout-project/insciout-project/blob/master/Column%20Names.csv).
